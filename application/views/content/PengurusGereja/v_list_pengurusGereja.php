...
<head>
	...
	<title>List PengurusGereja</title>
	<!-- CSS only CDN -->
...
<div id="content"  style="width: 1500px;">
		<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background-color: #173014;">
			...
			<div>
				<h3 style="color: #9A8D8D;">Data Pengurus Gereja </h3>
			</div>
		</nav>
		<div class="card-body">
			<a href="<?= site_url('PengurusGereja/tambah') ?>" class="btn btn-primary">
						...
						?>
							<tr>
								...
								<td>
									...
									<a href="#" data-id="<?= $PG->id_pengurusGereja ?>" class="btn btn-danger btn-sm btn-delete-PengurusGereja">
		...
		<form id="form-delete" method="post" action="<?= site_url('PengurusGereja/delete') ?>">
...
<script>
	$(function() {
		let idpengurusGereja = 0
		$(".btn-delete-PengurusGereja").on("click", function() {
			idpengurusGereja = $(this).data("id");
			console.log(idpengurusGereja);
		...
		$("#btn-delete").on("click", function() {
			...
			let inputId = $("<input>")
				.attr("type", "hidden")
				.attr("name", "id_pengurusGereja")
				.val(idpengurusGereja);
